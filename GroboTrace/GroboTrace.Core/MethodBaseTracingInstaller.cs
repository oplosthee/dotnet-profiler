...
namespace GroboTrace.Core
{
    ...
    public static unsafe class MethodBaseTracingInstaller
    {
        ...
        {
            //Trace.WriteLine("[Managed] In InstallTracing");
            ...
            // TODO: This might need to be removed to trace calls accurately.
            ...
            response.methodBodySize = (uint)methodBytes.Length;
        ...
        public static void AddMethodToMap(MethodBase method, int methodId)
        {
        ...
        public static MethodBase GetMethod(int id)
        {
            ...
            // If methodMap is not null, then we are being called from the server.
            // Therefore, we return the value stored in the map instead of the client only array.
            if (methodMap != null)
            {
                return methodMap[id];
            }
        ...
        public static Dictionary<int, MethodBase> methodMap;
